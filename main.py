...
def check_audio_file(audio_path):
    st.write("Checking file:", audio_path)
    ...
    columns = ['chroma_stft', 'rms', 'spectral_centroid', 'spectral_bandwidth', 'rolloff', 'zero_crossing_rate'] # Создание DataFrame
    ...
    features_scaled = features_scaled.reshape((features_scaled.shape[0], features_scaled.shape[1], 1))  #стандартизации
